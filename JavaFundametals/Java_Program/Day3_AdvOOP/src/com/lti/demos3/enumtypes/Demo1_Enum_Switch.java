...
//can be a top-level type like a class or interface, as well as a nested type like an inner class.
...
//in memory :
	/*
	 * 
	 * final class Dir extends java.lang.Enum { public static final Dir LEFT= new Dir(); public static final Dir RIGHT= new Dir(); public static final Dir UP=
...
public class Demo1_Enum_Switch
{
    ...
    {    
    	...
    	//That is from 1.5 version onwards we can use enum type as argument to switch statement  // 1.7 onward String was also allowed inside switch 
        
        switch( m1.ordinal() )   // LINE A
        {
            case 0: System.out.println( "You are going left" );
                                               break;
        
            case 1: System.out.println( "You are going right" );
                                                break;
        
            case 2: System.out.println( "You are going up" );
                                             break;
        
            case 3: System.out.println( "You are going down" );
                                               break;
 ...
 * enum's explicitly. Hence we can't apply extends keyword for enum's . But enum
