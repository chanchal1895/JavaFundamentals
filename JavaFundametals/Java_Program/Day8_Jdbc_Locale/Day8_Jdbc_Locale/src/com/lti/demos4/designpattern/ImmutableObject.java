...
Lists, arrays, maps, sets and other non-immutable objects .
 ...
 * mmutable class in java means that once an object is created, we cannot change its content.
  ...
  *   Prior to going ahead do go through characteristics of immutability in order to have a good understanding
  *    while implementing the same. Following are the requirements: 
  */
/*
...
final class Student {
    ...
    private final String name;   // say Brandname 
    private final int regNo;      // BrandCode etc     
