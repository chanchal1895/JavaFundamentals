...
public class JavaMethodOverloading {
 ...
 //    public void fly( int[] members ) {}
    ...
    // 3.
    // Autoboxing
    // Java will try to use the most specific parameter list     // it can find.
    ...
    public void referenceType( Object arg ) {
        System.out.println("Object org "+ arg);
    }
    ...
    public static void main(String[] args) {
        ...
        new JavaMethodOverloading().called(I);

        // 4.
        new JavaMethodOverloading().referenceType("hello");
