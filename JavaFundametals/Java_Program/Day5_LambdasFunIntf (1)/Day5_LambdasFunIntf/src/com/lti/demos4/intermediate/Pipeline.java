...
public class Pipeline {
	...
	public static void main(String[] args) {
		 ...
		 * List<String> filtered = new ArrayList<>(); for (String name : list) { if
		 * (name.length() == 4) { filtered.add(name); } } Collections.sort(filtered);
		...
		/*
		 * infinite = Stream.iterate(1, x -> x + 1); infinite.limit(5)
